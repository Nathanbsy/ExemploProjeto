...
namespace ExemploProjeto.Controllers
{
    public class EditorasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdEditora,NomeEditora")] Editora editora)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdEditora,NomeEditora")] Editora editora)
        {
